"""
Variant C: Stock Identity Embedding (emb_dim=32) + 30 epochs + CosineAnnealingLR
"""
...
def run():
    ...
    config['stock_emb_dim'] = 32  # enable stock identity embedding
