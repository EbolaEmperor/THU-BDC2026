"""
Variant A: 30 epochs + CosineAnnealingLR scheduler (baseline extension)
"""
...
sys.path.insert(0, os.path.dirname(script_dir))  # variants dir for predict_helper

mp.set_start_method('spawn', force=True)
VARIANT_NAME = 'A_30epoch'
...
def run():
    ...
    print(f"[{VARIANT_NAME}] epochs={config['num_epochs']}, scheduler=CosineAnnealingLR")
    start = time.time()
    try:
